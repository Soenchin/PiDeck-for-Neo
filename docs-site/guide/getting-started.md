...
PiDeck for NeoNisch（NN）是一个面向长期协作的本地 AI 桌面工作台。它负责桌面端工作流，Agent 能力仍由 [pi](https://pi.dev) CLI 提供。
...
[打开 NeoNisch 分支 Releases](https://github.com/SoenChin/PiDeck-for-Neo/releases)
