...
"config.emptyExtensions": "No installed extensions.",
  ...
  "menu.unpinSession": "Unpin",
  "sidebar.pinnedSession": "Pinned",
  "sidebar.unreadReply": "Finished in background — click to view",
  ...
  "settings.tabs.automationDesc": "Daily summaries and idle autonomous activity",
  ...
  "automation.daily.title": "Daily summary",
  "automation.daily.description": "Reads today's sessions and creates a memory candidate. It can request a durable-memory write only after you edit and approve it.",
  "automation.daily.enabled": "Enable daily summary",
  "automation.daily.time": "Run time",
  "automation.daily.minTurns": "Minimum user-message turns",
  "automation.daily.minTurnsDesc": "Skip the summary below this number of user turns to avoid interrupting you for fragments.",
  "automation.failure.output-limit": "Daily summary reached the output limit. The incomplete result was not offered for review or saving. Check automation logs before retrying.",
  "automation.failure.incomplete": "Daily summary has no complete final answer (reasoning only or unfinished response). It was not offered for review or saving. Please retry.",
  "automation.failure.agent-error": "Daily summary generation failed. Check automation in the application logs.",
  "automation.failure.no-activity": "Daily summary skipped: not enough valid user messages today. See automation logs for details.",
  "automation.daily.runNow": "Generate candidate now",
  "automation.daily.runNowDesc": "Save settings first. Uses the saved minimum turns and review flow, may call a paid model, and never writes memory automatically.",
  "automation.daily.running": "Requesting…",
  "automation.daily.started": "Request accepted. Review opens when the candidate is ready. If nothing appears, check automation in the application logs for skips or failures.",
  "automation.daily.failed": "Request failed. Check the application logs and ensure the main process was restarted.",
  "automation.daily.disabled": "Daily summary is disabled. Enable and save it first.",
  "automation.daily.already-running": "A summary is already generating or awaiting review. Do not trigger it again.",
  "automation.autonomous.title": "Idle autonomous activity",
  "automation.autonomous.description": "Runs an isolated temporary Agent only while you are away. Disabled by default and bounded by duration and round limits.",
  "automation.autonomous.enabled": "Enable idle autonomous activity",
  "automation.autonomous.idleThreshold": "Idle threshold (minutes)",
  "automation.autonomous.idleThresholdDesc": "Starts only after Windows idle reaches the threshold and the presence probe reports AWAY; it stops immediately when you return.",
  "automation.autonomous.modelProvider": "Model provider (optional)",
  "automation.autonomous.modelId": "Model ID (optional)",
  "automation.autonomous.modelDesc": "Leave both blank to use pi's default model.",
  "automation.autonomous.search": "Allow public research",
  "automation.autonomous.games": "Allow low-risk web games",
  "automation.reviewTitle": "Review daily summary",
  "automation.reviewDescription": "Memory candidate for {date}. Edit it freely; confirmation is required before it can request a diary and Houkai write.",
  "automation.reviewContent": "Daily summary content",
  "automation.reviewCancel": "Discard this run",
  "automation.reviewConfirm": "Confirm and save",
  "automation.reviewUnavailable": "This daily-summary review has expired or was already handled.",
  ...
  "agent.loading.responding1": "Cutting through the knot",
  "agent.loading.responding2": "Sharpening the blade",
  "agent.loading.responding3": "Flipping through the scratch paper",
  "agent.loading.responding4": "Trying another angle",
  "agent.loading.responding5": "Getting a little hungry",
  "agent.loading.responding6": "Writing it out for you",
  "agent.loading.responding7": "Letting the ideas branch out",
  "agent.loading.responding8": "Fully focused",
  "agent.loading.responding9": "Untangling the threads",
  "agent.loading.responding10": "Sorting out the thoughts",
  "agent.loading.responding11": "Which page was I on?",
  "agent.loading.responding12": "Let me take another look",
  "agent.loading.responding13": "Wait, let me think",
  "agent.loading.responding14": "Getting the gears turning",
  "agent.loading.responding15": "There\u2019s something to this",
  "agent.loading.responding16": "Almost got it",
  "agent.loading.responding17": "Jotting this down",
  "agent.loading.responding18": "Running the numbers again",
  "agent.loading.responding19": "Ears up",
  "agent.loading.responding20": "On my way",
  "agent.loading.responding21": "Almost there",
