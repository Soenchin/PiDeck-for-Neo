...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "sidebar.pinnedSession": "已置顶",
  "sidebar.unreadReply": "后台已完成，点击查看",
  ...
  "settings.tabs.automation": "自动化",
  "settings.tabs.automationDesc": "每日总结与空闲自主活动",
  "imagegen.done": "图片已生成",
  ...
  "automation.daily.title": "每日自动总结",
  "automation.daily.description": "每天读取当日会话生成记忆候选；只能在你编辑审核并确认后请求写入权威记忆。",
  "automation.daily.enabled": "启用每日总结",
  "automation.daily.time": "执行时间",
  "automation.daily.minTurns": "最少用户消息轮数",
  "automation.daily.minTurnsDesc": "当天少于此轮数时不生成总结，避免零碎聊天打扰你。",
  "automation.failure.output-limit": "每日总结触及模型输出上限，结果不完整，未进入审核或保存。请查看 automation 日志后重试。",
  "automation.failure.incomplete": "每日总结没有完整的最终正文（可能只有思考或响应未完成），未进入审核或保存。请重试。",
  "automation.failure.agent-error": "每日总结生成失败，请在应用日志 automation 分类查看原因。",
  "automation.failure.no-activity": "每日总结已跳过：当天有效用户消息不足，详情见 automation 日志。",
  "automation.daily.runNow": "立即生成候选",
  "automation.daily.runNowDesc": "请先保存设置。使用已保存的最少轮数和同一审核流程，可能调用付费模型；不会自动写入记忆。",
  "automation.daily.running": "正在请求…",
  "automation.daily.started": "请求已受理。候选生成后会弹出审核；未出现时请在应用日志中查看 automation 的跳过或失败原因。",
  "automation.daily.failed": "请求失败，请检查应用日志并确认主进程已重启。",
  "automation.daily.disabled": "每日总结尚未启用，请先启用并保存。",
  "automation.daily.already-running": "已有总结正在生成或等待审核，请勿重复触发。",
  "automation.autonomous.title": "空闲自主活动",
  "automation.autonomous.description": "只在主人离开电脑后运行独立临时 Agent；默认关闭，所有活动受时间和轮次上限约束。",
  "automation.autonomous.enabled": "启用空闲自主活动",
  "automation.autonomous.idleThreshold": "空闲阈值（分钟）",
  "automation.autonomous.idleThresholdDesc": "Windows 空闲达到阈值且 presence 判定为 AWAY 才会启动；主人回来会立刻停止。",
  "automation.autonomous.modelProvider": "模型 Provider（可选）",
  "automation.autonomous.modelId": "模型 ID（可选）",
  "automation.autonomous.modelDesc": "两项都留空则使用 pi 默认模型。",
  "automation.autonomous.search": "允许公开资料检索",
  "automation.autonomous.games": "允许无风险网页小游戏",
  "automation.reviewTitle": "审核每日总结",
  "automation.reviewDescription": "{date} 的记忆候选。可直接编辑；确认后才会请求写入 diary 和 Houkai。",
  "automation.reviewContent": "每日总结内容",
  "automation.reviewCancel": "放弃本次",
  "automation.reviewConfirm": "确认并保存",
  "automation.reviewUnavailable": "该每日总结审核已失效或已被处理。",
  ...
  "agent.loading.responding1": "快刀斩乱麻",
  "agent.loading.responding2": "磨刀中",
  "agent.loading.responding3": "翻翻草稿纸",
  "agent.loading.responding4": "换个角度想想",
  "agent.loading.responding5": "有点饿了",
  "agent.loading.responding6": "写给你看",
  "agent.loading.responding7": "发散思维",
  "agent.loading.responding8": "聚精会神",
  "agent.loading.responding9": "捋捋线头",
  "agent.loading.responding10": "理理思路",
  "agent.loading.responding11": "翻到哪页了",
  "agent.loading.responding12": "让我再看一眼",
  "agent.loading.responding13": "等等我想想",
  "agent.loading.responding14": "脑子转起来",
  "agent.loading.responding15": "这事有点东西",
  "agent.loading.responding16": "差不多摸到了",
  "agent.loading.responding17": "先记在这里",
  "agent.loading.responding18": "再算一遍",
  "agent.loading.responding19": "耳朵竖起来",
  "agent.loading.responding20": "这就来",
  "agent.loading.responding21": "马上就好",
