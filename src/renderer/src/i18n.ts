...
const zhCN = {
  ...
  "artifact.previewUnavailable": "暂时无法预览",
  "app.model": "模型",
  "app.new": "新会话",
  "app.newSession": "新会话",
  ...
  "room.entryTitle": "和 Neo 与小 R 一起玩",
  "room.entryName": "和Neo与小R一起玩！",
  "room.panelTitle": "Neo × ROCKET 房间",
  "room.entrySub": "主人、Neo、ROCKET 三人聊天",
  "room.you": "主人",
  "room.composerPlaceholder": "对 Neo 和 ROCKET 说点什么… Enter 发送，Shift+Enter 换行",
  "room.send": "发送",
  "room.stop": "停止",
  "room.provisioning": "正在准备房间（首次进入会拉起两个独立 Agent）…",
  "room.errorGeneric": "房间准备出错了，稍后重试",
  "room.empty": "和 Neo、ROCKET 打个招呼吧 ✨",
  "room.imageOnly": "（图片）",
  "room.removeImage": "点击移除",
  "room.relay": "让另一位接话",
  "room.relayDisplay": "让 {other} 接着说",
  "room.relayHint": "以上内容来自另一位独立房间成员。请以你自己的观点接着讨论，不要复述，目标成员：{other}",
  "room.modelTitle": "切换房间 Agent 模型",
  "room.modelDefault": "默认模型",
  "room.modelLoading": "正在加载模型…",
  "room.contextTitle": "{name} 的独立上下文占用：{percent}",
  "room.clear": "清屏",
  "room.clearTitle": "只清空房间画面，保留两人的上下文与长期记忆",
  "room.newTable": "新开一桌",
  "room.newTableTitle": "为 Neo 和小 R 创建全新上下文",
  "room.newTableConfirm": "当前房间画面会清空，Neo 和小 R 将各自创建全新 Session，上下文归零。旧 Session 文件与双方长期记忆不会删除。",
  "room.newTableConfirmAction": "新开一桌",
  ...
  "app.ctx": "上下文",
  "app.cache": "缓存总量",
  "app.cacheHit": "会话缓存命中率",
  "app.cacheRead": "缓存读取",
  "app.cacheWrite": "缓存写入",
  "app.cacheLastTurn": "本轮缓存",
  "app.cacheLastTurnHit": "本轮命中率",
  "app.cacheMissReason": "Miss 原因",
  "app.cacheMissFirstTurn": "首轮请求",
  "app.cacheMissProviderNoCache": "Provider 无缓存数据",
  "app.cacheMissIdleTimeout": "空闲超时 (>5分钟)",
  "app.cacheMissModelChanged": "模型已切换",
  "app.cacheMissCompactionRebuild": "压缩后重建",
  "app.cacheMissCacheChainReset": "缓存链断裂",
  "app.cacheMissProviderNoCacheHint": "中转站可能不支持或不回传缓存统计",
  "app.statusDetails": "状态详情",
  "app.statusDetailsSubtitle": "缓存、上下文与费用概览",
  "app.statusCacheOverview": "缓存表现",
  "app.statusUsageOverview": "累计用量",
  "app.statusModelOverview": "模型",
  "app.statusProvider": "Provider",
  "app.statusCurrentModelLabel": "当前：",
  "app.statusContextUsage": "上下文占用",
  "app.statusContextTokens": "上下文 Token",
  "app.statusInputTokens": "输入 Token",
  "app.statusOutputTokens": "输出 Token",
  "app.statusUsageRings": "用量环",
  "app.statusRingCache": "缓存命中",
  "app.statusRingBalance": "余额",
  "app.statusRingBalanceCap": "上限 {cap}",
  "app.statusRingToday": "今日花费",
  "app.statusRingSubscriptionTodayRemaining": "订阅今日剩余",
  "app.statusRingTodayBudget": "预算 {cap}",
  "app.statusRingTodayRemaining": "剩余 {amount}",
  "app.statusRingTodayOver": "超出 {amount}",
  "app.statusRingContext": "上下文",
  "app.statusRingTurn": "本轮命中",
  "app.usageAccountOverview": "账户用量",
  "app.usageBalance": "账户余额",
  "app.usageToday": "今日实际用量",
  "app.usageTotal": "累计实际用量",
  "app.usageTodayRequests": "今日请求",
  "app.usageTodayTokens": "今日 Token",
  "app.usageTotalTokens": "累计 Token",
  "app.usageTotalRequests": "累计请求",
  "app.usageUpdatedAt": "更新于 {time}",
  "app.usageActual": "实际扣除",
  "app.usageSubscription": "订阅额度",
  "app.usageEstimated": "理论估算",
  "app.usageRefreshing": "刷新中…",
  "app.usageRefresh": "刷新用量",
  "app.usageFetchFailed": "用量查询失败",
  "app.usageUnavailable": "暂时没有用量数据",
  "app.usageInvalid": "账户无效或不可用",
  "app.totalCost": "总费用",
  "app.cycleModel": "切换模型",
  "app.compact": "压缩",
  "app.compacting": "压缩中…",
  ...
  "app.composerAskPendingPlaceholder": "先回答上面的问题，再继续讨论吧~",
  ...
  "app.fileReferenceDropFailed": "未能读取拖入文件的路径，请重启 PiDeck 后重试。",
  "app.clipboardImageReferenceFailed": "截图未能保存为文件引用，请重启 PiDeck 后重试。",
  ...
  "app.deleteAgentSessionTitle": "删除会话",
  "app.deleteAgentSessionConfirm": "将停止「{name}」并永久删除它的会话记录。此操作不会删除项目文件，且无法撤销。",
  ...
  "app.statusError": "失败",
  "app.statusQuestion": "小问题",
  "app.unreadMessages": "有未读回复",
  ...
  "config.subagents.title": "Subagent 模型",
  "config.subagents.hint": "不配置时 subagent 继承主会话当前模型",
  "config.subagents.defaultModel": "默认模型",
  "config.subagents.overrides": "角色覆盖",
  "config.subagents.addOverride": "添加角色覆盖",
  "config.subagents.rolePlaceholder": "角色名，如 reviewer",
  "config.subagents.roleTooltip": "内置角色：reviewer | planner | worker | researcher | scout | oracle | delegate | context-builder",
  "config.subagents.removeOverride": "删除该覆盖",
  "config.subagents.disableThinking": "关闭 thinking",
  "config.subagents.disableThinkingHint": "禁用所有 subagent 的思考过程",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "editor.preview": "预览",
  "editor.loadFailed": "差异查看器加载失败",
  "editor.loadFailedHint": "开发服务器刚刚更新或存在编译错误。关闭后重试；若仍失败，请重启 PiDeck 开发窗口。",
  "editor.source": "源码",
  "editors.clear": "清除",
  "editors.browse": "浏览",
  ...
  "drawer.gitChangedFiles": "修改",
  "drawer.gitChangedFilesDesc": "",
  "drawer.gitChangesNone": "工作区干净，无未提交变更",
  "drawer.gitTabWorkingTree": "修改",
  "drawer.gitTabCommits": "历史",
  "drawer.gitTabRemote": "远端",
  "drawer.gitCommitsTitle": "历史",
  "drawer.gitRemoteTitle": "远端",
  "drawer.gitRemoteNoUpstream": "当前分支未设置远端跟踪分支",
  "drawer.gitRemoteAhead": "领先 ${ahead} 个提交",
  "drawer.gitRemoteBehind": "落后 ${behind} 个提交",
  "drawer.gitRemoteFetch": "刷新远端",
  "drawer.gitRemoteFetching": "刷新中...",
  "drawer.gitRemoteFetchFailed": "远端刷新失败",
  "drawer.gitNoCommits": "暂无提交记录",
  "drawer.gitNoRemoteCommits": "暂无远端提交记录",
  "drawer.gitCommitBy": "${author} 提交于 ${date}",
  "drawer.gitFileAdded": "新",
  "drawer.gitFileModified": "改",
  "drawer.gitFileDeleted": "删",
  "drawer.gitFileRenamed": "重命名",
  "drawer.gitNotARepo": "当前项目不是 Git 仓库",
  "drawer.gitExpand": "展开其余 {count} 条",
  "drawer.gitCollapse": "收起历史",
  ...
  "settings.tabs.automation": "自动化任务",
  "settings.tabs.automationDesc": "每日总结与自主活动",
  ...
  "settings.automation.dailySummary.title": "每日总结",
  "settings.automation.dailySummary.desc": "定时生成当天对话的总结并写入记忆系统",
  "settings.automation.dailySummary.enable": "启用每日总结",
  "settings.automation.dailySummary.enableDesc": "每天定时自动生成总结，需要审核后才会保存到记忆",
  "settings.automation.dailySummary.time": "触发时间",
  "settings.automation.dailySummary.requireReview": "需要审核后保存",
  "settings.automation.dailySummary.requireReviewDesc": "生成总结后弹窗预览，确认后再写入记忆系统",
  "settings.automation.dailySummary.minTurns": "最小对话轮数",
  "settings.automation.dailySummary.minTurnsDesc": "当天对话轮数少于此值时跳过总结",
  "settings.automation.autonomous.title": "自主活动模式",
  "settings.automation.autonomous.desc": "检测到用户空闲时启动自主活动",
  "settings.automation.autonomous.enable": "启用自主活动",
  "settings.automation.autonomous.enableDesc": "长时间无操作时 Agent 可以自己搜索感兴趣的内容或玩小游戏",
  "settings.automation.autonomous.idleThreshold": "空闲阈值（分钟）",
  "settings.automation.autonomous.idleThresholdDesc": "超过此时间无操作则启动自主模式",
  "settings.automation.autonomous.modelProvider": "自主活动模型 Provider",
  "settings.automation.autonomous.modelId": "自主活动模型 ID",
  "settings.automation.autonomous.modelDesc": "两项都填写才会覆盖默认模型；留空则使用 Pi 默认模型",
  "settings.automation.autonomous.activities": "活动类型",
  "settings.automation.autonomous.activitySearch": "自主搜索",
  "settings.automation.autonomous.activityGames": "玩小游戏",
  "settings.automation.autonomous.silentReturn": "静默停止",
  "settings.automation.autonomous.silentReturnDesc": "用户回来时不弹窗汇报，直接停止活动",
  "settings.automation.status.title": "状态",
  "settings.automation.status.desc": "当前自动化任务的状态概览",
  "settings.automation.status.dailySummaryStatus": "每日总结",
  "settings.automation.status.autonomousStatus": "自主活动",
  "settings.automation.status.enabled": "已启用，触发时间 {time}",
  "settings.automation.status.enabledIdle": "已启用，空闲 {minutes} 分钟后触发",
  "settings.automation.status.disabled": "未启用",
  "settings.automation.status.noActivity": "已启用，但未选择活动",
  "dailySummary.reviewTitle": "每日总结审核",
  "dailySummary.summaryContent": "总结内容",
  "dailySummary.summaryPlaceholder": "在这里编辑总结内容...",
  "dailySummary.reviewHint": "审核并编辑总结内容后，点击确认保存将其写入记忆系统。",
  "dailySummary.cancel": "取消",
  "dailySummary.confirmAndSave": "确认保存",
  "dailySummary.saveFailed": "每日总结保存请求失败",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "app.files": "Files",
  "artifact.title": "Task artifacts",
  "artifact.openFile": "Open file",
  "artifact.previewUnavailable": "Preview unavailable",
  "app.model": "Model",
  "app.new": "New Session",
  ...
  "room.entryTitle": "Hang out with Neo and Little R",
  "room.entryName": "Hang out with Neo & Little R!",
  "room.panelTitle": "Neo × ROCKET Room",
  "room.entrySub": "Chat with Neo, ROCKET and you",
  "room.you": "You",
  "room.composerPlaceholder": "Say something to Neo and ROCKET… Enter to send, Shift+Enter for newline",
  "room.send": "Send",
  "room.stop": "Stop",
  "room.provisioning": "Preparing the room (spawning two independent agents on first entry)…",
  "room.errorGeneric": "Something went wrong preparing the room. Try again later.",
  "room.empty": "Say hi to Neo and ROCKET ✨",
  "room.imageOnly": "(image)",
  "room.removeImage": "Click to remove",
  "room.relay": "Let the other reply",
  "room.relayDisplay": "Let {other} continue",
  "room.relayHint": "The content above came from another independent room member. Continue with your own viewpoint; do not repeat it. Target member: {other}",
  "room.modelTitle": "Switch room agent model",
  "room.modelDefault": "Default model",
  "room.modelLoading": "Loading models…",
  "room.contextTitle": "{name} independent context usage: {percent}",
  "room.clear": "Clear screen",
  "room.clearTitle": "Clear the room view while keeping both contexts and long-term memories",
  "room.newTable": "New table",
  "room.newTableTitle": "Create fresh contexts for Neo and Little R",
  "room.newTableConfirm": "The room view will be cleared and Neo and Little R will each start a fresh Session. Old Session files and long-term memories will not be deleted.",
  "room.newTableConfirmAction": "Start new table",
  ...
  "app.path": "Path",
  "app.ctx": "Context",
  "app.cache": "Cache Total",
  "app.cacheHit": "Session Cache Hit Rate",
  "app.cacheRead": "Cache Read",
  "app.cacheWrite": "Cache Write",
  "app.cacheLastTurn": "Last Turn Cache",
  "app.cacheLastTurnHit": "Last Turn Hit Rate",
  "app.cacheMissReason": "Miss Reason",
  "app.cacheMissFirstTurn": "First Turn",
  "app.cacheMissProviderNoCache": "Provider No Cache Data",
  "app.cacheMissIdleTimeout": "Idle Timeout (>5min)",
  "app.cacheMissModelChanged": "Model Changed",
  "app.cacheMissCompactionRebuild": "Compaction Rebuild",
  "app.cacheMissCacheChainReset": "Cache Chain Reset",
  "app.cacheMissProviderNoCacheHint": "Provider may not support or report cache stats",
  "app.statusDetails": "Status Details",
  "app.statusDetailsSubtitle": "Cache, context, and cost overview",
  "app.statusCacheOverview": "Cache performance",
  "app.statusUsageOverview": "Session usage",
  "app.statusModelOverview": "Model",
  "app.statusProvider": "Provider",
  "app.statusCurrentModelLabel": "Current:",
  "app.statusContextUsage": "Context usage",
  "app.statusContextTokens": "Context tokens",
  "app.statusInputTokens": "Input tokens",
  "app.statusOutputTokens": "Output tokens",
  "app.statusUsageRings": "Usage rings",
  "app.statusRingCache": "Cache hit",
  "app.statusRingBalance": "Balance",
  "app.statusRingBalanceCap": "Cap {cap}",
  "app.statusRingToday": "Today spend",
  "app.statusRingSubscriptionTodayRemaining": "Subscription left today",
  "app.statusRingTodayBudget": "Budget {cap}",
  "app.statusRingTodayRemaining": "{amount} left",
  "app.statusRingTodayOver": "{amount} over",
  "app.statusRingContext": "Context",
  "app.statusRingTurn": "Last turn",
  "app.usageAccountOverview": "Account usage",
  "app.usageBalance": "Balance",
  "app.usageToday": "Today actual",
  "app.usageTotal": "Total actual",
  "app.usageTodayRequests": "Today requests",
  "app.usageTodayTokens": "Today tokens",
  "app.usageTotalTokens": "Total tokens",
  "app.usageTotalRequests": "Total requests",
  "app.usageUpdatedAt": "Updated {time}",
  "app.usageActual": "Actual charge",
  "app.usageSubscription": "Subscription quota",
  "app.usageEstimated": "Estimated",
  "app.usageRefreshing": "Refreshing…",
  "app.usageRefresh": "Refresh usage",
  "app.usageFetchFailed": "Usage request failed",
  "app.usageUnavailable": "Usage data unavailable",
  "app.usageInvalid": "Account invalid or unavailable",
  ...
  "app.composerAskPendingPlaceholder": "Answer the question above before continuing~",
  "app.composerEnterPlaceholder":
  ...
  "app.fileReferenceDropFailed": "Could not read the dropped file path. Restart PiDeck and try again.",
  "app.clipboardImageReferenceFailed": "Could not save the screenshot as a file reference. Restart PiDeck and try again.",
  ...
  "app.deleteAgentSessionTitle": "Delete session",
  "app.deleteAgentSessionConfirm": "This will stop “{name}” and permanently delete its session history. Project files will not be deleted and this cannot be undone.",
  ...
  "app.statusQuestion": "Question",
  "app.unreadMessages": "Unread reply",
  ...
  "ask.cancelQuestion": "Cancel current question",
  ...
  "ask.cancelHint": "Cancel current question",
  ...
  "config.subagents.title": "Subagent Models",
  "config.subagents.hint": "Subagents inherit the current session model when unset",
  "config.subagents.defaultModel": "Default model",
  "config.subagents.overrides": "Per-role overrides",
  "config.subagents.addOverride": "Add role override",
  "config.subagents.rolePlaceholder": "Role name, e.g. reviewer",
  "config.subagents.roleTooltip": "Built-in roles: reviewer | planner | worker | researcher | scout | oracle | delegate | context-builder",
  "config.subagents.removeOverride": "Remove override",
  "config.subagents.disableThinking": "Disable thinking",
  "config.subagents.disableThinkingHint": "Disable thinking for all subagents",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "editor.loadFailed": "Diff viewer failed to load",
  "editor.loadFailedHint": "The development server just updated or has a compile error. Close and retry; if it persists, restart the PiDeck development window.",
  ...
  "drawer.gitChangedFiles": "Changes",
  "drawer.gitChangedFilesDesc": "",
  "drawer.gitChangesNone": "Working tree clean, no uncommitted changes",
  "drawer.gitTabWorkingTree": "Changes",
  "drawer.gitTabCommits": "History",
  "drawer.gitTabRemote": "Remote",
  "drawer.gitCommitsTitle": "History",
  "drawer.gitRemoteTitle": "Remote",
  "drawer.gitRemoteNoUpstream": "Current branch has no remote tracking branch",
  "drawer.gitRemoteAhead": "${ahead} commits ahead",
  "drawer.gitRemoteBehind": "${behind} commits behind",
  "drawer.gitRemoteFetch": "Fetch Remote",
  "drawer.gitRemoteFetching": "Fetching...",
  "drawer.gitRemoteFetchFailed": "Fetch failed",
  "drawer.gitNoCommits": "No commits yet",
  "drawer.gitNoRemoteCommits": "No remote commits yet",
  "drawer.gitCommitBy": "${author} committed on ${date}",
  "drawer.gitFileAdded": "A",
  "drawer.gitFileModified": "M",
  "drawer.gitFileDeleted": "D",
  "drawer.gitFileRenamed": "R",
  "drawer.gitNotARepo": "Current project is not a Git repository",
  "drawer.gitExpand": "Show {count} more",
  "drawer.gitCollapse": "Collapse history",
  ...
  "menu.deleteAgentSession": "Delete session",
  ...
  "menu.openInBrowser": "Open in built-in browser",
  ...
  "settings.tabs.automationDesc": "Daily summary and autonomous activities",
  ...
  "settings.automation.dailySummary.title": "Daily Summary",
  "settings.automation.dailySummary.desc": "Automatically generate daily conversation summaries and save to memory",
  "settings.automation.dailySummary.enable": "Enable daily summary",
  "settings.automation.dailySummary.enableDesc": "Generate summary at scheduled time, requires review before saving to memory",
  "settings.automation.dailySummary.time": "Trigger time",
  "settings.automation.dailySummary.requireReview": "Require review before saving",
  "settings.automation.dailySummary.requireReviewDesc": "Show preview modal after generation, confirm before saving to memory",
  "settings.automation.dailySummary.minTurns": "Minimum conversation turns",
  "settings.automation.dailySummary.minTurnsDesc": "Skip summary if daily turns are less than this value",
  "settings.automation.autonomous.title": "Autonomous Mode",
  "settings.automation.autonomous.desc": "Start autonomous activities when user is idle",
  "settings.automation.autonomous.enable": "Enable autonomous mode",
  "settings.automation.autonomous.enableDesc": "Agent can search interesting topics or play games when idle for long time",
  "settings.automation.autonomous.idleThreshold": "Idle threshold (minutes)",
  "settings.automation.autonomous.idleThresholdDesc": "Start autonomous mode after this period of inactivity",
  "settings.automation.autonomous.modelProvider": "Autonomous model provider",
  "settings.automation.autonomous.modelId": "Autonomous model ID",
  "settings.automation.autonomous.modelDesc": "Both fields are required to override the default model; leave blank to use Pi's default",
  "settings.automation.autonomous.activities": "Activity types",
  "settings.automation.autonomous.activitySearch": "Autonomous search",
  "settings.automation.autonomous.activityGames": "Play games",
  "settings.automation.autonomous.silentReturn": "Silent stop",
  "settings.automation.autonomous.silentReturnDesc": "Stop activities silently when user returns, no notification",
  "settings.automation.status.title": "Status",
  "settings.automation.status.desc": "Overview of current automation tasks",
  "settings.automation.status.dailySummaryStatus": "Daily summary",
  "settings.automation.status.autonomousStatus": "Autonomous mode",
  "settings.automation.status.enabled": "Enabled, trigger time {time}",
  "settings.automation.status.enabledIdle": "Enabled, trigger after {minutes} minutes idle",
  "settings.automation.status.disabled": "Disabled",
  "settings.automation.status.noActivity": "Enabled, but no activity is selected",
  "dailySummary.reviewTitle": "Daily Summary Review",
  "dailySummary.summaryContent": "Summary Content",
  "dailySummary.summaryPlaceholder": "Edit summary content here...",
  "dailySummary.reviewHint": "Review and edit the summary, then click Confirm to save it to memory.",
  "dailySummary.cancel": "Cancel",
  "dailySummary.confirmAndSave": "Confirm & Save",
  "dailySummary.saveFailed": "Failed to submit the daily summary",
