...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "settings.autoCheckUpdateDesc": "启动后 5 秒及每 6 小时自动检查新版本",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.autoCheckUpdate": "Auto-check for updates",
  "settings.autoCheckUpdateDesc": "Automatically check for new versions 5 seconds after launch and every 6 hours",
