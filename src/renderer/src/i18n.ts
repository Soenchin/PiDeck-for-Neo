...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "settings.automation.autonomous.developmentDesc": "配置入口已保留，执行功能仍在开发中",
  ...
  "settings.automation.status.development": "开发中，暂不执行",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.automation.autonomous.developmentDesc": "Configuration is reserved while execution remains under development",
  ...
  "settings.automation.status.development": "In development, not running yet",
